...
/* Construction / destruction / assignment */
  ...
  //  Added by B.Menzel on the recommendation of Fabien Benichou --- October  2004
  //  This was added so the Cruise system will not allow mixed case on strings
  static bool _CaseSensitive;
